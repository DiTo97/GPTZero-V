"""Streamlit handler for GPTZero service using SDK."""
            ...
            try:
                ...
                with subcolumns[0]:
                    ...
                    if result.c2pa_metadata and not result.error:
                        ...
                        c2pa_content += f"<li><strong>generated by:</strong> {c2pa.generator_name}</li>"
                        ...
                        if c2pa.software_agents:
                            ...
                            for agent in c2pa.software_agents:
                                c2pa_content += (
                                    f"<li><strong>{agent.formatted_action}</strong> {agent.name}</li>"
                                )
                            c2pa_content += "</ul>"
                        else:
                            c2pa_content += "."
                        ...
                        c2pa_content += (
                            f"<li><strong>issued by:</strong> {c2pa.issuer}</li>"
                        )
                        c2pa_content += "</ul>"
